...
class YOLOParser(BaseParser):
    ...
    def parse_with_progress(self, input_dir: Path, 
        ...
        # 完成进度
        if progress_callback:
            progress_callback(total_files, total_files, "YOLO解析完成")
    ...
    def export_with_progress(self, annotations: List[ImageAnnotation], output_dir: Path,
        ...
        # 完成进度
        if progress_callback:
            progress_callback(total_annotations, total_annotations, "YOLO导出完成")
