...
- **Microsoft YaHei / Segoe UI**: 统一使用微软雅黑/Segoe UI，优化中文显示体验
...
### v2.1.2 (2026-01-28)
- **界面重构**: 全新侧边栏导航设计，采用深色侧边栏+绿色顶部栏的仪表盘风格
- **数据可视化**: 新增可视化仪表盘，提供数据集统计卡片和图表预览
- **数据增强**: 统一了几何变换（翻转/旋转）的标签同步逻辑，支持YOLO格式自动调整
- **样式优化**: 修复了样式表语法错误，优化了选项卡选中效果（高亮边框+圆角）
- **字体更新**: 全局默认字体调整为Microsoft YaHei，提升显示效果
